...
export default function UpdatePasswordPage() {
  ...
  return (
    <div className="app-shell min-h-screen bg-[#F6FBF7] pb-[calc(2rem+env(safe-area-inset-bottom,0px))]">
      <header className="mobile-top bg-white">
        <div className="flex items-center justify-between">
          <Link href="/login" className="text-[0.68rem] font-black uppercase tracking-[0.12em] text-[#0F2B20]/50 no-underline hover:text-[#0F2B20]">Retour</Link>
      ...
      <main className="mt-6 px-4">
        <section className="mx-auto max-w-[440px] rounded-[34px] bg-white p-6 shadow-[0_16px_34px_rgba(13,23,18,0.08)] ring-1 ring-[#0F2B20]/10">
          <div className="mb-6 flex items-start gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[20px] bg-[#F6FBF7] text-[#059669] ring-1 ring-[#0F2B20]/5">
              {success ? <CheckCircle2 size={26} /> : <KeyRound size={26} />}
            </div>
            <div className="min-w-0">
              <h1 className="font-display text-2xl font-black leading-8 text-[#0F2B20]">
          ...
          {success ? (
            <Link href="/login" className="flex min-h-[58px] w-full items-center justify-center rounded-[20px] bg-[#059669] text-base font-black text-white no-underline shadow-sm active:scale-[0.98] transition-transform">
              Retour connexion
            </Link>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!checkingLink && !linkReady && (
                <Link href="/onboarding" className="flex min-h-[52px] w-full items-center justify-center rounded-[20px] bg-[#F6FBF7] text-sm font-black text-[#059669] no-underline ring-1 ring-[#0F2B20]/10 active:scale-[0.98] transition-transform">
                  Demander un nouveau lien
                </Link>
              )}
              <label className="block">
                <span className="mb-1.5 block text-xs font-black uppercase tracking-[0.1em] text-[#0F2B20]/50">Nouveau mot de passe</span>
                <input
                  value={password}
              ...
              <label className="block">
                <span className="mb-1.5 block text-xs font-black uppercase tracking-[0.1em] text-[#0F2B20]/50">Confirmer</span>
                <input
              ...
              <button
                ...
                className="mt-6 flex min-h-[58px] w-full items-center justify-center gap-2 rounded-[20px] bg-[#0F2B20] text-base font-black text-[#34D399] shadow-[0_16px_34px_rgba(15, 43, 32,0.22)] active:scale-[0.98] transition-transform disabled:opacity-50 disabled:active:scale-100"
              >
