  ...
  return (
    <OnboardingLayout>
      <div className="flex min-h-dvh w-full flex-col px-4 py-8 lg:justify-center">
        ...
        <div className="mt-6">
          <p className="text-[0.68rem] font-black uppercase tracking-[0.14em] text-[#059669]">
            {mode === "SIGN_IN" ? "Connexion" : "Étape 1 sur 2"}
          </p>
          <h1 className="mt-1 font-display text-3xl font-black text-[#0F2B20]">
      ...
      <form onSubmit={onSubmit} className="mx-auto mt-6 w-full max-w-sm space-y-3">
        ...
        <div className="overflow-hidden rounded-[22px] bg-white ring-1 ring-[#0F2B20]/8">
          <label htmlFor="onb-phone" className="flex min-h-[68px] cursor-text items-center gap-0 px-4 py-3">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[14px] bg-[#E8F7EE] text-[#059669] mr-3">
            ...
            <span className="min-w-0 flex-1">
              <span className="block text-[0.62rem] font-black uppercase tracking-[0.12em] text-[#059669]">Numéro WhatsApp (Côte d&apos;Ivoire)</span>
              <div className="mt-0.5 flex items-center gap-1.5">
                {/* Fixed prefix */}
                <span className="shrink-0 select-none rounded-lg bg-[#E8F7EE] px-2 py-0.5 text-sm font-black text-[#059669]">+225</span>
                <input
                  id="onb-phone"
                  type="tel"
                  inputMode="numeric"
                  ...
                  className="w-full bg-transparent text-sm font-black text-[#0F2B20] outline-none placeholder:text-[#0F2B20]/30"
                  autoComplete="tel-local"
                />
              </div>
            </span>
            {phoneOk && <CheckCircle2 size={17} className="shrink-0 text-[#059669] ml-2" />}
          </label>
            ...
            <span className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex items-center gap-2">
                ...
                <button
                  ...
                  className="shrink-0 text-[#0F2B20]/30 hover:text-[#0F2B20]/60"
            ...
            <div className="px-4 pb-3">
              ...
              <div className="mt-2 grid grid-cols-2 gap-x-3 gap-y-1">
                {[
                  ...
                  <span key={text} className={`flex items-center gap-1.5 text-[0.68rem] font-bold ${ok ? "text-[#059669]" : "text-[#0F2B20]/35"}`}>
                    <span className={`h-1.5 w-1.5 rounded-full shrink-0 ${ok ? "bg-[#059669]" : "bg-[#0F2B20]/20"}`} />
                    {text}
                  </span>
                ))}
              </div>
        ...
        <button
          ...
          className="flex min-h-[48px] w-full items-center justify-center gap-2 rounded-[18px] bg-white text-sm font-black text-[#0F2B20]/60 ring-1 ring-[#0F2B20]/8 active:scale-[0.98] transition"
        >
          {mode === "SIGN_UP" ? (
        ...
        {sellerAccount && (
          <button
            ...
            id="onb-signout-btn"
            onClick={onSignOut}
            className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[16px] text-xs font-bold text-[#0F2B20]/40 active:scale-[0.98]"
          >
