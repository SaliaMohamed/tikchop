                      ...
                      {expandedBulkItemId === item.id && (
                        <div className="mt-4 space-y-3 border-t border-[var(--outline)]/20 pt-4">
                          <div className="flex items-center justify-between gap-3 px-1">
                            <span className="flex h-9 items-center rounded-full bg-[#E6F5EC] px-3 text-xs font-black uppercase tracking-[0.12em] text-[var(--primary)]">
                              #{index + 1}
                            </span>
                          ...
                          />
                          <div className="rounded-[22px] bg-white p-3 ring-1 ring-[#0F2B20]/7 md:hidden">
                            <label className="block">
                              <span className="mb-2 block text-[0.62rem] font-black uppercase tracking-[0.13em] text-[#059669]">Nom</span>
                              <input
                                value={item.name}
                                onChange={(event) => updateBulkPhotoItem(item.id, "name", event.target.value)}
                                placeholder={item.analyzing ? "Tikchop prepare..." : "Nom visible"}
                                className="min-h-[48px] w-full rounded-[18px] bg-[#F6FBF7] px-3 text-sm font-black text-[#0F2B20] outline-none ring-1 ring-[#0F2B20]/8 focus:ring-[#059669]/35"
                              />
                            </label>
                          </div>
                          ...
                          {duplicateHint && (
                            <button
                              ...
                              className="flex min-h-[52px] w-full items-center justify-center gap-2 rounded-2xl border border-[var(--primary)]/25 bg-[#F4FAF6] px-3 text-sm font-black text-[var(--text-main)]"
                            >
                              <Layers3 size={16} />
                              {duplicateHint}
                            </button>
                          ...
                          <button
                            ...
                            className="flex min-h-[54px] w-full items-center justify-center gap-2 rounded-2xl bg-[#0F2B20] text-sm font-extrabold text-white shadow-[0_14px_30px_rgb(43_34_25_/_0.16)]"
                          >
