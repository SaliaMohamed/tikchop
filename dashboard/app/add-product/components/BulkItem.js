    ...
    <section className="rounded-[26px] bg-[#07120d] p-3 text-white shadow-[0_18px_40px_rgb(7_18_13_/_0.18)]">
      ...
      <div className="mt-3 grid grid-cols-[minmax(0,1fr)_4.4rem] gap-2">
        <input
          ...
          placeholder="15000"
          inputMode="numeric"
          className="min-h-[60px] w-full rounded-[22px] border border-white/10 bg-white px-4 font-display text-2xl font-extrabold text-[#008f5a] outline-none focus:border-[#39f58e] focus:shadow-[0_0_0_4px_rgb(57,245,142_/_0.16)]"
        />
        <button
          type="button"
          onClick={() => onNext(item.id)}
          className="flex min-h-[60px] items-center justify-center rounded-[22px] bg-[#39f58e] text-[#07120d] shadow-[0_14px_30px_rgb(57,245,142_/_0.18)] disabled:opacity-50"
          disabled={!hasPrice}
